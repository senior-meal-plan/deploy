...
public record FoodForWeeklyDto(
    ...
    public static FoodForWeeklyDto from(Food food) {
        return new FoodForWeeklyDto(
                food.getName(),
                food.getKcal(),
                food.getProtein(),
                food.getCarbs(),
                food.getFat(),
                food.getCalcium(),
                food.getServingSize(), // Food 엔티티에 getServingSize()가 있다고 가정
                food.getSaturatedFatPercentKcal(), // Food 엔티티에 getSaturatedFatPercentKcal()이 있다고 가정
